...
<template>
    ...
    <el-table
  	...
  	<pagination :page="clue.page" @clickPage="getClueList"></pagination>
  </div>	
...
<script>
  ...
  export default {
    ...
    methods: {
      getClueList() {
        let that = this
        Server.requestJsonNoLimit(URL + '/clue/list', {
          page: this.clue.page.pageIndex
        }, function (res) {
          
          that.clue.detailData = res.data
          that.GetPage(that.clue, res)   // 对clue.page赋值
          that.clue.loading = false
